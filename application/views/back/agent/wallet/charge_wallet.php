...
<div class="container">
    ...
    <div id="main-content"> 
				...
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="<?= site_url()?>agent/wallet">المحفظة</a></li> 
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>agent/do_charge_wallet" class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
									...
									<div class="form-body">
										...
										<div class="row">  
											<div class="col-sm-12 d-flex justify-content-end">
												...
												<a href="<?= site_url()?>agent/wallet" class="btn btn-light-secondary mb-1"> الغاء</a>
											</div> 
										</div>
									</div>
								</div>
