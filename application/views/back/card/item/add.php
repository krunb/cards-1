										...
										<div class="row"> 
											<div class="col-md-12">
												<div class="form-group ">
													...
													<input type="text" id="card_item_reference" name="card_item_reference" class="form-control form-control-lg">
												</div>
											</div>
										</div>
										<div class="row"> 
										...
										<div class="row"> 
											<div class="col-md-12">
												<div class="form-group ">
													...
													<input type="date" id="card_item_end" name="card_item_end" class="form-control form-control-lg"  value="<?= date('Y-m-d',strtotime(date("Y-m-d", time()) . " + 365 day"))?>">
												</div>
											</div>
										</div>
										<hr class="my-3">
