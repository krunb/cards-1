<div id="main">
    ...
    <div id="main-content"> 
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>card/update_card_item" class="form form-horizontal">
				<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
				<input type="hidden" name="card_id" value="<?= $card_info->card_id?>">
				<input type="hidden" name="card_item_id" value="<?= $view->card_item_id?>">
										...
										<div class="row"> 
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" id="card_item_code" name="card_item_code" value="<?= $view->card_item_code?>" class="form-control form-control-lg" required>
												</div>
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
												<div class="form-group ">
													...
													<input type="text" id="card_item_reference" name="card_item_reference" value="<?= $view->card_item_reference?>"  class="form-control form-control-lg">
												</div>
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
												<div class="form-group ">
													...
													<input type="text" id="card_item_serial" name="card_item_serial" value="<?= $view->card_item_serial?>"  class="form-control form-control-lg" required>
												</div>
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
												<div class="form-group ">
													...
													<input type="date" id="card_item_end" name="card_item_end" value="<?= $view->card_item_end?>"  class="form-control form-control-lg">
												</div>
											</div>
										</div>
										<hr class="my-3">
