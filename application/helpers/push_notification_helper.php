	...
	if(!function_exists('SendEmail')){
		function SendEmail($options = array()){
			...
			*/
			...
			$config = Array(
				'protocol' => 'smtp',
				'smtp_host' => 'ssl://mail.extracard-jo.com',
			//	'smtp_host' => 'ssl://ssmtp.googlemail.com',
			//	'smtp_port' => 465,
				'smtp_port' => 587,
				'smtp_user' => 'info@extracard-jo.com', // change it to yours
				'smtp_pass' => 'extra123789*', // change it to yours
				'mailtype' => 'html',
				'charset' => 'utf-8',
				'wordwrap' => TRUE
			); 
		...
		#	$CI->email->set_header('Content-Type', 'text/html');
			...
			$CI->email->from("info@extracard-jo.com", $options["subject"]);
